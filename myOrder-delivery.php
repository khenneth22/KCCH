    ...
    <div class="py-2  ">
        <div class="container mt-3 ">
            <div class=" mb-0 mx-2 border-0 rounded">
                <div class="card-body ">
                    <h5 class=""  style="letter-spacing: 2px;"><i class="fas fa-chevron-left" onclick="history.back();"></i><strong><strong> MY ORDER(S) </strong>
                   
                    <a href="myAllOrders.php" type="button" class="btn" style="float: right;" >view all <i class="fas fa-chevron-right"></i> </a>
                </h5>
                </div>
                <a href="myPendingOrders.php" class="btn btn-light shadow rounded">Pending<span class="badge rounded-pill bg-light border">
                          <?php 
                          $userId = $_SESSION['auth_user']['user_id'];
                         $dash_total_orders_query = "SELECT * FROM orders WHERE user_id='$userId' AND status='0' ";
                        ...
                        {
                            echo '<h5 class="mb-0 " style="font-size: 13px;">'.$orders_today.'</h5>';
                        }
                        else
                        {
                            echo '<h5 class="mb-0 " style="font-size: 13px;">0</h5>';
                        }   
                       ?>
                          </span></a>

                          <a href="my-orders.php" class="btn btn-light shadow">To Process <span class="badge rounded-pill bg-light border">
                          <?php 
                           $userId = $_SESSION['auth_user']['user_id'];
                         $dash_total_orders_query = "SELECT * FROM orders WHERE user_id='$userId' AND status='1' ";
                         $dash_total_orders_query_run = mysqli_query($con, $dash_total_orders_query);

                         if($orders_today = mysqli_num_rows($dash_total_orders_query_run))
                        {
                            echo '<h3 class="mb-0" style="font-size: 13px;">'.$orders_today.'</h3>';
                        }
                        else
                        {
                            echo '<h3 class="mb-0" style="font-size: 13px;">0</h3>';
                        }   
                       ?>
                          </span></a>

                          <a href="myOrder-delivery.php" class="btn  btn-dark shadow rounded">To Deliver <span class="badge rounded-pill bg-light border">
                          <?php 
                           $userId = $_SESSION['auth_user']['user_id'];
                         $dash_total_orders_query = "SELECT * FROM orders WHERE user_id='$userId' AND status='3' ";
                         $dash_total_orders_query_run = mysqli_query($con, $dash_total_orders_query);
                       ...
                       ?>
                          ...
                          <a href="myOrder-pickup.php" class="btn btn-light shadow rounded ">To Pick Up <span class="badge rounded-pill bg-light border">
                          <?php 
                           $userId = $_SESSION['auth_user']['user_id'];
                         $dash_total_orders_query = "SELECT * FROM orders WHERE user_id='$userId' AND status='4' ";
                         $dash_total_orders_query_run = mysqli_query($con, $dash_total_orders_query);
                    ...
                    <div class="col-md-12 order-parent">
                        <!-- <table class="table align-items-center">
                            ...
                            <?php
                                    ...
                                    $orders = getDeliveryOrders();//getOrdersUsers
                                            ...
                                            <div class="card m-2 shadow border-0  rounded order-container">
                                                <div class="card-body m-1">
                                                    <div class="row align-items-center">   
                                                        ...
                                                        <div class="col-md-3"><!-- status of the order -->
                                                        ...
                                                        <!-- <div class="col-md-2">
                                                        <label class="lbl"><strong>Service mode</strong></label><br>
                                    ...
                                    <div class="col-md-12 text-center mt-3">
                                        <input class="load-more-btn btn shadow mt-3" type="button" id="play" value="Load more"/>
                                    </div>
                            <!-- </tbody>
                        </table> -->
