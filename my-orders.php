    ...
    <div class="py-2  ">
        <div class="container mt-3 ">
            <div class=" mb-0 mx-2 border-0 rounded">
                <div class="card-body ">
                    <h5 class=""  style="letter-spacing: 2px;"><i class="fas fa-chevron-left" onclick="history.back();"></i><strong> MY ORDER(S) </strong>
                       ...
                       ?>
                          ...
                          <a href="my-orders.php" class="btn btn-dark shadow rounded">To Process<span id="class" class="badge rounded-pill bg-light border">
                          <?php 
                           $userId = $_SESSION['auth_user']['user_id'];
                        ...
                        {
                            echo '<h5 class="mb-0 " id="hideMe" style="font-size: 13px;">0</h5>';
                        }   
                       ?>
                          </span></a>
                          
                          <a href="myOrder-delivery.php" class="btn btn-light shadow rounded">To Deliver <span class="badge rounded-pill bg-light border">
                          <?php 
                           $userId = $_SESSION['auth_user']['user_id'];
                    ...
                    <div class="col-md-12 order-parent">
                        <!-- <table class="table align-items-center">
                            ...
                            <?php
                                    ...
                                    $orders = getProcessOrders();//getOrdersUsers
