            ...
            <div class=" mb-0 mx-2 border-0 rounded">
                ...
                <a href="myPendingOrders.php" class="btn btn-light shadow rounded">Pending<span class="badge rounded-pill bg-light border">
                       ...
                       ?>
                          ...
                          <a href="my-orders.php" class="btn btn-white shadow">To Process <span class="badge rounded-pill bg-light border">
                          <?php 
                          $userId = $_SESSION['auth_user']['user_id'];
                       ...
                       ?>
                          ...
                          <a href="myOrder-pickup.php" class="btn btn-dark shadow rounded ">To Pick Up <span class="badge rounded-pill bg-light border">
                          <?php 
                          $userId = $_SESSION['auth_user']['user_id'];
                    ...
                    <div class="col-md-12 order-parent">
                        <!-- <table class="table align-items-center">
                            ...
                            <?php
                                    ...
                                    $orders = getPickupOrders();//getOrdersUsers
