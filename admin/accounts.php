  ...
  <div class="row">
    <div class="col-12">
      <div class="card my-4">
        ...
        <div class="col-md-12" ><a href="adminAcc.php" class="mx-3 my-3 btn" style="float: right;">view admin</a></div>
            ...
            <table id="myDataTable" class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Customers</th>
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-xs text-secondary"><?php if($item['is_verified'] == 1 )
                          {
                            echo '<span>Verified</span>';
                          }else{
                            echo '<span>Not Verified</span>';
                          }
                          ?></h6>
                        </div>
                      </td>
