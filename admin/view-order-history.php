...
$page_title = "Kape Catalina's - Processing Order";
...
<div class="py-0 ">
    <div class="container mt-0 ">
        <div class="card mb-2 border-0 rounded bg-gradient-dark ">
            <div class="card-body">
                <h4 class="text-white text-center" style="letter-spacing: 2px; text-transform: uppercase;">Processing Order</h4>
            ...
            <ul class="nav nav-pills nav-fill mb-2 mt-1 bg-outline-light">
                ...
                <li class="nav-item">
                    <a class="nav-link active bg-white" href="#"><i class="fa fa-clock-o" aria-hidden="true"></i> Processing 
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <tr>
                                            ...
                                            <a href="view-order.php?t=<?= $item['tracking_no']; ?>" class="btn btn-dark rounded my-2">View Details</a>
                        ...
                        ?>
                        <tr>
                            <td colspan="7" class="text-center">No orders to process yet!</td>
                        </tr>
                    <?php
                    }
                    ?>
