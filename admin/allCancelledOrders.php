...
$page_title = "Kape Catalina's - Cancelled Orders";
...
<div class="py-0 ">
    <div class="container mt-0 ">
        <div class="card mb-2 border-0 rounded bg-gradient-dark ">
            <div class="card-body">
                <h4 class="text-white text-center" style="letter-spacing: 2px; text-transform: uppercase;">Cancelled Order</h4>
            </div>
        </div>
            <ul class="nav nav-pills nav-fill mb-2 mt-1 bg-outline-light">
                ...
                <li class="nav-item">
                <a class="nav-link  active bg-white" href="allCancelledOrders.php"><i class="fa fa-trash-o" aria-hidden="true"></i> Cancelled</a>
                </li>
            </ul>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <tr>
                        ...
                        ?>
                        <tr>
                            <td colspan="5">No available for Cancelled orders yet!</td>
                        </tr>
                    <?php
                    }
                    ?>
