<?php
$page_title = "Kape Catalina's - Deliver Orders";
...
<div class="py-0 ">
    <div class="container mt-0 ">
        <div class="card mb-2 border-0 rounded bg-gradient-dark ">
            <div class="card-body">
                <h4 class="text-white text-center" style="letter-spacing: 2px; text-transform: uppercase;">To Deliver Order</h4>
            </div>
        </div>
            <ul class="nav nav-pills nav-fill mb-2 mt-1 bg-outline-light">
                ...
                <li class="nav-item">
                    <a class="nav-link active bg-white" href="allDeliveryOrders.php"><i class="fa fa-truck" aria-hidden="true"></i> To Deliver
                    <span class="badge px-3 bg-danger"><?php 
            ...
            <li class="nav-item">
                <a class="nav-link" href="allPickupOrders.php"><i class="fa fa-map-pin" aria-hidden="true"></i> To Pick-up
                <span class="badge px-3 bg-danger"><?php 
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <tr>
                                            ...
                                            <a href="orderHistory-details.php?t=<?= $item['tracking_no']; ?>" class="btn btn-dark rounded">View Details</a>
                                             </td>  
                                            <td class=" text-center">
                                                <form action="#" method="post">
                                                <input type="hidden" name="id" value="<?= $item['id'] ?>">
                                                <button type="submit" name="delivered_order" class="btn btn-dark rounded">delivered</button>
                                                </form>
                                             </td>  
                        </tr>
                        ...
                        ?>
                        <tr>
                            <td colspan="7" class="text-center">No orders to delivery yet!</td>
                        </tr>
                    <?php
                    }
                    ?>
...
<?php
      ...
      {
        $id = $_POST['id'];
        $delivery_status_query = "UPDATE orders SET status='2' WHERE id='$id' ";
