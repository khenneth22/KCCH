    ...
    <div class="py-2  ">
        <div class="container mt-3 ">
            <div class=" mb-0 mx-2 border-0 rounded">
                ...
                <a href="myPendingOrders.php" class="btn btn-dark shadow rounded">Pending<span class="badge rounded-pill bg-light border">
                          <?php 
                       ...
                       ?>
                          ...
                          <a href="my-orders.php" class="btn btn-light shadow rounded">To Process<span class="badge rounded-pill bg-light border">
                          <?php 
                          $userId = $_SESSION['auth_user']['user_id'];
                    ...
                    <div class="col-md-12 order-parent">
                        <!-- <table class="table align-items-center">
                            ...
                            <?php
                                    ...
                                    $orders = getPendingOrders();//getOrdersUsers
