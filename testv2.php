                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header border-0 bg-primary py-3">
                            <h4>View Order
                            <button href="" class="text-dark btn btn-primary" onclick="history.back();" style="float: right;"><i class="fa fa-angle-left"></i> Back</button>
                        </h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-body border-0 rounded">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <hr>
                            <h6>Delivery Fee: <span class="float-right">
                            ...
                            <h5 class="mt-3">Total Price : <span class="float-right">&#8369  <?php echo $grandtotal ?> <span id="totalPrice"></span><span id="totalPriceV2"></span></span></h5>
                                ...
                                <div class="mt-5">
                                    ...
                                    <label class="font-weight-bold">Service Mode:</label> <span style="float: right;">
                                ...
                                <?php
                                                ...
                                                {
                                                    ?>
                                                                                    <p class="mt-2">How was the taste of our drinks? <br> Are you satisfied? If Yes, then give us feedback.</p>
